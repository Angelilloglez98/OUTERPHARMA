        ...
        <nav class="nav">
            <div> <a href="Inicio.php" class="nav_logo"> <img src="assets/logo.png" class="outerpharma"> <span
                ...
                <div class="nav_list"> <a href="Inicio.php" class="nav_link"> <i class='bx bxs-home-alt-2 nav_icon'></i>
                    ...
                    <a href="historialVentas.php" class="nav_link active"> <i class='bx bxs-credit-card nav_icon'></i>
                        <span class="nav_name">Historial Ventas</span> </a>
                </div>
                <?php
            ...
            <div class="container-fluid">
                <div class="row rounded">
                    ...
                    <div class="contenedorTitulo">
                        <h2 class='titulo'>Historial ventas</h2>
                    </div>
