    ...
    <div class="l-navbar" id="nav-bar">
      <nav class="nav">
          <div> <a href="Inicio.php" class="nav_logo"> <img src="assets/logo.png" class="outerpharma"> <span class="nav_logo-name">OuterPharma</span> </a>
              <div class="nav_list"> <a href="Inicio.php" class="nav_link active"> <i class='bx bxs-home-alt-2 nav_icon'></i> <span class="nav_name">Inicio</span> </a>
              ...
              <div class="row column-gap-3 row-gap-3 gap-0 rounded">
                ...
                <div class="p-2 col-sm-6">
                  ...
                  <form action="BaseDatos/devProductosMasVendidos.php" method="GET">
                    <select name="fecha" class="btn  mb-2 border-dark-subtle">
