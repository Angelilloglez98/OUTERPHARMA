        ...
        <nav class="nav">
            <div> <a href="Inicio.php" class="nav_logo"> <img src="assets/logo.png" class="outerpharma"> <span
                ...
                <div class="nav_list"> <a href="Inicio.php" class="nav_link"> <i class='bx bxs-home-alt-2 nav_icon'></i>
                    ...
                    <a href="inventario.php" class="nav_link active"> <i class='bx bxs-box nav_icon'></i> <span
                ...
                <div class="row rounded">
                    ...
                    <nav class="navbar bg-body-tertiary">
                        <div class="container my-3">
                            <form role="search">
                                <input id="busqueda" class="form-control input me-2" type="search" placeholder="Buscar"
                                    aria-label="Search">
                                <!-- <button class="btn btn-outline-success" type="submit">Search</button> -->
                                <div class='ordenar my-3'>
                                    <p> Ordenar por: </p>
                                     <div class="wrapper d-flex align-items-center btn botonesOrd">
                                    ...
                                    <div class="row">
                                        <div class="col-12 pedirCN d-flex flex-column align-items-center">
                                            <form class="codigo" role="search" action="">
                                                <input id="cn" class="cN input form-control me-2" type="search"
                                                    name="CodigoNacional" placeholder="Codigo de barra"
                                                    aria-label="Search">
                                                <input type="button" value="" id="codigoBarra" class="botonverde ">
                                            </form>
                                        </div>
                                        <div class="col-12 btn-group d-flex align-items-center" role="group"
                                            aria-label="Basic radio toggle button group">
                                            <input type="radio" class="btn-check" name="funcion" id="insertar"
                                                autocomplete="off">
                                            <label class="btn btn-outline-success" for="insertar">+</label>

                                            <input type="radio" class="btn-check" name="funcion" id="borrar"
                                                autocomplete="off">
