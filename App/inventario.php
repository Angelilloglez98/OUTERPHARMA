            ...
            <nav class="navbar bg-body-tertiary">
                <div class="container">
                  <form role="search">
                    ...
                    <p>Ordenar por:</p>
                    <div class="wrapper d-flex align-items-center btn btn-secondary">
                        <input type="button" value="Nombre" class="btn  btn-rounded busqueda">
                    </div>
                    
                    <div class="wrapper d-flex align-items-center btn btn-secondary ms-5">
                        ...
                        <div class="col-2">
                            <div class="row">
                                <div class="col-12 pedirCN d-flex flex-column align-items-center">
                                    <form class="codigo" action="">
                                        <input class="cN" type="text" name="CodigoNacional" id="cn" placeholder="Codigo de barra">
